package net.pk.onlineshopping.handler;
...
import net.pk.onlineshopping.model.CheckOutModel;
import net.pk.onlineshopping.model.UserModel;
import net.pk.shoppingbackend.dao.CartLineDAO;
...
import net.pk.shoppingbackend.dto.CartLine;
import net.pk.shoppingbackend.dto.OrderDetail;
import net.pk.shoppingbackend.dto.OrderItem;
...
public class CheckoutHandler {
	...
	public String saveOrder(CheckOutModel checkoutModel) {
		...
		for(CartLine cartLine : cartLines) {
			...
			product.setPurchase(product.getPurchase() + cartLine.getProductCount());
