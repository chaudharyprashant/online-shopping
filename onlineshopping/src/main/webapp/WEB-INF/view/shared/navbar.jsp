...
<body>
	<!-- Navigation -->
	<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation" style="color:#adad85">
	<div class="container">
		...
		<div class="collapse navbar-collapse"
			...
			<ul class="nav navbar-nav">
				<li id="about"><a href="${contextRoot}/about"></a></li>
				<li id="listProducts"><a
					href="${contextRoot}/show/all/products">View Products</a></li>
				<li id="contact"><a href="${contextRoot}/contact"></a></li>
         ...
         <security:authorize access="isAuthenticated()">
				<li class=="dropdown id="userCart"><a href="javascript:void(0)"
					class="btn btn-default dropdown-toggle" id="dropdowmMenu1"
