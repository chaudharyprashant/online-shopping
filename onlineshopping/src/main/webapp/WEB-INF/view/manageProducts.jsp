					...
					<sf:form class="form-horizontal" modelAttribute="product"
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								...
								<sf:errors path="name" style="color:red" cssClass="help-block"
									element="em" />
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								...
								<sf:errors path="brand" style="color:red" cssClass="help-block"
									element="em" />
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								...
								<sf:errors path="description" style="color:red"
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								...
								<sf:errors path="unitPrice" style="color:red"
									cssClass="help-block" element="em" />
